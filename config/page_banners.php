...
return [
    ...
    */
    'pages' => [
        ...
        ['key' => 'department_cardiology', 'label' => 'Department: Cardiology', 'route' => 'departments.show', 'route_params' => ['department' => 'cardiology']],
        ['key' => 'department_cardiothoracic-surgery', 'label' => 'Department: Cardiothoracic Surgery', 'route' => 'departments.show', 'route_params' => ['department' => 'cardiothoracic-surgery']],
        ['key' => 'department_endoscopy', 'label' => 'Department: Endoscopy', 'route' => 'departments.show', 'route_params' => ['department' => 'endoscopy']],
        ['key' => 'department_pharmacy', 'label' => 'Department: Pharmaceutical / Pharmacy', 'route' => 'departments.show', 'route_params' => ['department' => 'pharmacy']],
        ...
        ['key' => 'training_medical_education', 'label' => 'Medical Education', 'route' => 'training.medical-education'],
