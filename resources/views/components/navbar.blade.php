                        ...
                        <li class="relative group">
                            <a href="{{ $href }}"
                               class="ctc-nav-link px-3 py-2 inline-flex items-center gap-1 border-b-2 pb-1 transition-all {{ $isActive ? 'is-active' : 'border-transparent' }}">
                                {{ $item['label'] }}
                                <svg class="ctc-nav-chevron w-4 h-4 opacity-60" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
                            ...
                            @else
                                <div class="ctc-dropdown absolute left-0 top-full pt-2">
                                    <div class="ctc-dropdown__panel min-w-64 rounded-xl border border-gray-200 bg-white shadow-lg overflow-hidden">
                                        <ul class="py-2">
